...
on simplicity. If you want to unlock the full potential of **OpenMx**, **mxsem**
may not be the best option.

> **Warning**: The syntax and settings of **mxsem** may differ from 
**lavaan** in some cases. See `vignette("Syntax", package = "mxsem")` for more details on the syntax and the 
default arguments.

## Alternatives

**mxsem** is new and may still have some sharp edges. Fortunately, there are other
packages that also try to simplify implementing **OpenMx** models. You may consider
the following:
